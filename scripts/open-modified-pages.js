...
const MODIFIED_PAGES = [
  ...
  ['/secteurs-desservis', 'Secteurs – Photo header (sector hub)'],
  ...
  ['/secteurs-desservis/montreal', 'Montréal – Photo header + guides blog'],
  ['/secteurs-desservis/laval', 'Laval – Photo header'],
  ['/secteurs-desservis/longueuil', 'Longueuil – Photo header'],
  ['/secteurs-desservis/brossard', 'Brossard – Photo header'],
];
