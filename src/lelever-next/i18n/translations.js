export const translations = {
  fr: {
    ...
    sectorsSubtitle: 'Nous intervenons dans tout le Grand Montréal',
    viewAllSectors: 'Voir tous les secteurs desservis',

    resourcesTitle: 'Conseils & ressources',
  ...
  en: {
    ...
    benefit1Desc:
      'Clean, uniform, detailed work, all done right the first time',
    benefit2Title: 'No stress, no damage',
    benefit2Desc:
      'We protect everything. Your home stays intact from start to finish',
    benefit3Title: 'Speed and punctuality',
    benefit3Desc: 'We arrive on time. We finish on time. No excuses',
    benefit4Title: '5-star service',
    ...
    sectorsTitle: 'Service areas',
    sectorsSubtitle: 'We serve all of Greater Montreal',
    viewAllSectors: 'View all service areas',

    resourcesTitle: 'Tips & resources',
