export const translations = {
  fr: {
    ...
    serviceResidentialDesc: 'Maisons, condos, appartements',
    serviceResidentialStrip: 'Peinture soignée pour votre espace de vie.',
    serviceCommercial: 'Commercial',
    serviceCommercialDesc: 'Bureaux, restaurants, commerces',
    serviceCommercialStrip: 'Travaux hors heures, zéro perturbation.',
    serviceInterior: 'Intérieure',
    serviceInteriorDesc: 'Murs, plafonds, boiseries, armoires',
    serviceInteriorStrip: 'Finitions nettes et durables.',
    serviceExterior: 'Extérieure',
    serviceExteriorDesc: 'Revêtement, balcon, clôture',
    serviceExteriorStrip: 'Protection contre le climat québécois.',
    serviceIndustrial: 'Industrielle',
    serviceIndustrialDesc: 'Entrepôt, usine, stationnement',
    serviceIndustrialStrip: 'Époxy et revêtements spécialisés.',
    ...
    teamTitle: 'Une équipe de peintres dédiés à votre projet',
    teamDescription:
      'Nos peintres ont chacun plus de 10 ans d’expérience et sont formés pour livrer un travail impeccable.',
    ...
    formSubmit: 'Envoyer',
    formPaintingType: 'Type de peinture',
    formInteriorPainting: 'Peinture intérieure',
    formExteriorPainting: 'Peinture extérieure',
    formConsentText: "J'accepte les",
    formTermsAndConditions: 'termes et conditions',
    formAnd: 'ainsi que la',
    formPrivacyPolicy: 'politique de confidentialité',
    formOf:
    ...
    recentProjectsSubtitle:
      'Aperçu de quelques projets résidentiels et commerciaux réalisés par notre équipe',
    projectResidential: 'Projet résidentiel',
    projectCommercial: 'Projet commercial',
  ...
  en: {
    ...
    serviceResidential: 'Residential',
    serviceResidentialDesc: 'Houses, condos, apartments',
    serviceResidentialStrip: 'Careful painting for your living space.',
    serviceCommercial: 'Commercial',
    serviceCommercialDesc: 'Offices, restaurants, shops',
    serviceCommercialStrip: 'After-hours work, zero disruption.',
    serviceInterior: 'Interior',
    serviceInteriorDesc: 'Walls, ceilings, woodwork, cabinets',
    serviceInteriorStrip: 'Clean and durable finishes.',
    serviceExterior: 'Exterior',
    serviceExteriorDesc: 'Siding, balcony, fence',
    serviceExteriorStrip: 'Protection against the Quebec climate.',
    serviceIndustrial: 'Industrial',
    serviceIndustrialDesc: 'Warehouse, factory, parking',
    serviceIndustrialStrip: 'Epoxy and specialized coatings.',
    ...
    teamTitle: 'A team of painters dedicated to your project',
    teamDescription:
      'Our painters each have over 10 years of experience and are trained to deliver impeccable work.',
    ...
    formSubmit: 'Send',
    formPaintingType: 'Painting type',
    formInteriorPainting: 'Interior painting',
    formExteriorPainting: 'Exterior painting',
    formConsentText: 'I accept the',
    formTermsAndConditions: 'terms and conditions',
    formAnd: 'as well as the',
    ...
    recentProjectsSubtitle:
      'Overview of some residential and commercial projects completed by our team',
    projectResidential: 'Residential project',
    projectCommercial: 'Commercial project',
