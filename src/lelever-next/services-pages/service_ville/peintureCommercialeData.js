  ...
  'peinture-commerciale': {
    ...
    cities: {
      brossard: {
        ...
        slug: 'brossard',
        canonical:
          'https://leleverdupinceau.ca/services/peinture-commerciale/brossard',
        h1: {
          fr: 'Peinture commerciale à Brossard – Le Lever du Pinceau',
        ...
        whyUsTitle: {
          ...
          en: 'A service designed for Brossard businesses',
        },
        whyUsContent: {
          fr: [
        ...
        whyUsIntro: {
          fr: 'Nos interventions commerciales sont conçues pour :',
          en: 'Our commercial interventions are designed to:',
        },
        whyUsOutro: {
          fr: "Nous travaillons dans : commerces de détail, restaurants, bureaux, cliniques, cabinets, centres de services, espaces au DIX30, halls d'immeubles, etc.",
          en: 'We work in: retail stores, restaurants, offices, clinics, offices, service centers, spaces at DIX30, building halls, etc.',
        },
        subServicesTitle: {
        ...
        projectsTitle: {
          ...
          en: 'Projects completed in Brossard businesses and offices',
        },
        projects: {
          fr: [
            {
        ...
        ctaTitle: {
          ...
          en: 'Get your quote for a commercial project in Brossard',
        },
        ctaDescription: {
        ...
        sectors: [],
        images: [
          { src: img5969, alt: 'Peinture commerciale Brossard' },
          { src: img5970, alt: 'Peinture commerciale Brossard' },
          { src: img5971, alt: 'Peinture commerciale Brossard' },
          { src: img5972, alt: 'Peinture commerciale Brossard' },
          { src: img5973, alt: 'Peinture commerciale Brossard' },
          { src: img5974, alt: 'Peinture commerciale Brossard' },
        ],
        subServices: {
          interior: {
            title: {
          ...
          exterior: {
            ...
            link: '/services/peinture-commerciale/exterieure/brossard',
            linkText: {
              fr: 'Page dédiée',
              en: 'Dedicated page',
            },
      ...
      laval: {
        ...
        slug: 'laval',
        canonical:
          'https://leleverdupinceau.ca/services/peinture-commerciale/laval',
        h1: {
          fr: 'Peinture commerciale à Laval – Le Lever du Pinceau',
        ...
        whyUsTitle: {
          ...
          en: 'A fast, organized service adapted to Laval businesses',
        },
        whyUsContent: {
          fr: [
        ...
        whyUsIntro: {
          fr: 'Nos services de peinture commerciale incluent :',
          en: 'Our commercial painting services include:',
        },
        whyUsOutro: {
          fr: "Nous travaillons dans : bureaux, commerces, restaurants, centres médicaux, salles d'attente, halls d'immeubles, espaces de coworking, cabinets professionnels.",
          en: 'We work in: offices, stores, restaurants, medical centers, waiting rooms, building halls, coworking spaces, professional offices.',
        },
        subServicesTitle: {
        ...
        guidesTitle: {
          ...
          en: 'Plan a commercial painting project in Laval well',
        },
        guides: [
          {
            title: {
              fr: 'Comment choisir un peintre pour entreprise ?',
              en: 'How to choose a painter for business?',
            },
            href: '/blog/comment-choisir-un-peintre-professionnel',
          },
          {
        ...
        projectsTitle: {
          ...
          en: 'Projects completed in Laval businesses and offices',
        },
        projects: {
          fr: [
            {
        ...
        ctaTitle: {
          ...
          en: 'Get your quote for a commercial project in Laval',
        },
        ctaDescription: {
        ...
        sectors: [],
        images: [
          { src: img5969, alt: 'Peinture commerciale Laval' },
          { src: img5970, alt: 'Peinture commerciale Laval' },
          { src: img5971, alt: 'Peinture commerciale Laval' },
          { src: img5972, alt: 'Peinture commerciale Laval' },
          { src: img5973, alt: 'Peinture commerciale Laval' },
          { src: img5974, alt: 'Peinture commerciale Laval' },
        ],
        subServices: {
          interior: {
            title: {
          ...
          exterior: {
            ...
            link: '/services/peinture-commerciale/exterieure/laval',
            linkText: {
              fr: 'Page dédiée',
              en: 'Dedicated page',
            },
      ...
      longueuil: {
        ...
        slug: 'longueuil',
        canonical:
          'https://leleverdupinceau.ca/services/peinture-commerciale/longueuil',
        h1: {
          fr: 'Peinture commerciale à Longueuil – Le Lever du Pinceau',
        ...
        whyUsTitle: {
          ...
          en: 'A service designed for Longueuil businesses',
        },
        whyUsContent: {
          fr: [
            "Travaux réalisés en dehors des heures d'ouverture si nécessaire",
            "Protection complète de l'équipement et des zones sensibles",
            'Produits à faible odeur et séchage rapide selon le besoin',
            'Finition impeccable conforme à votre image de marque',
            'Respect absolu des délais convenus',
            'Équipe formée pour les environnements professionnels (sécurité, organisation)',
            'Solutions pour grands espaces ou petits locaux professionnels',
          ],
          en: [
            'Work done outside opening hours if necessary',
            'Complete protection of equipment and sensitive areas',
            'Low-odor and fast-drying products as needed',
            'Impeccable finish conforming to your brand image',
            'Absolute respect of agreed deadlines',
            'Team trained for professional environments (safety, organization)',
            'Solutions for large spaces or small professional premises',
          ],
        },
        whyUsIntro: {
          fr: 'Nous offrons :',
        ...
        whyUsOutro: {
          fr: "Nous intervenons dans : bureaux, commerces, restaurants, cliniques, cabinets, halls d'immeubles, centres de services, espaces de coworking.",
          en: 'We work in: offices, stores, restaurants, clinics, offices, building halls, service centers, coworking spaces.',
        },
        subServicesTitle: {
        ...
        projectsTitle: {
          ...
          en: 'Projects completed in Longueuil businesses and offices',
        },
        projects: {
          fr: [
            {
        ...
        aboutTitle: {
          ...
          en: 'A team of commercial painters active on the South Shore',
        },
        aboutDescription: {
          fr: "Nos peintres sont habitués de travailler dans des environnements professionnels avec des contraintes de temps, de sécurité et d'organisation.",
          en: 'Our painters are used to working in professional environments with time, safety and organization constraints.',
        },
        ctaTitle: {
          fr: 'Obtenez votre soumission pour un projet commercial à Longueuil',
          en: 'Get your quote for a commercial project in Longueuil',
        },
        ctaDescription: {
        ...
        sectors: [],
        images: [
          { src: img5969, alt: 'Peinture commerciale Longueuil' },
          { src: img5970, alt: 'Peinture commerciale Longueuil' },
          { src: img5971, alt: 'Peinture commerciale Longueuil' },
          { src: img5972, alt: 'Peinture commerciale Longueuil' },
          { src: img5973, alt: 'Peinture commerciale Longueuil' },
          { src: img5974, alt: 'Peinture commerciale Longueuil' },
        ],
        subServices: {
          interior: {
            title: {
          ...
          exterior: {
            ...
            link: '/services/peinture-commerciale/exterieure/longueuil',
            linkText: {
              fr: 'Page dédiée',
              en: 'Dedicated page',
            },
      ...
      montreal: {
        ...
        slug: 'montreal',
        canonical:
          'https://leleverdupinceau.ca/services/peinture-commerciale/montreal',
        h1: {
          fr: 'Peinture commerciale à Montréal – Le Lever du Pinceau',
        ...
        whyUsTitle: {
          ...
          en: 'A service designed for Montreal businesses',
        },
        whyUsContent: {
          fr: [
            "Travaux effectués en dehors des heures d'ouverture si nécessaire",
            'Équipe rapide, discrète et organisée',
            'Produits à faible odeur ou séchage rapide',
            'Protection complète des équipements et zones sensibles',
            'Respect strict des délais',
            'Finition impeccable conforme à votre image de marque',
            'Gestion des projets multi-pièces ou multi-étages',
          ],
          en: [
            'Work done outside opening hours if necessary',
            'Fast, discreet and organized team',
            'Low-odor or fast-drying products',
            'Complete protection of equipment and sensitive areas',
            'Strict respect of deadlines',
            'Impeccable finish conforming to your brand image',
            'Management of multi-room or multi-story projects',
          ],
        },
        whyUsIntro: {
          fr: 'Nos avantages pour les projets commerciaux :',
          en: 'Our advantages for commercial projects:',
        },
        whyUsOutro: {
          fr: "Nous travaillons dans : bureaux, commerces, restaurants, cliniques, cabinets, écoles privées, halls d'immeubles, espaces de coworking, salles d'attente.",
          en: 'We work in: offices, stores, restaurants, clinics, offices, private schools, building halls, coworking spaces, waiting rooms.',
        },
        subServicesTitle: {
        ...
        guidesTitle: {
          ...
          en: 'Plan a commercial painting project in Montreal well',
        },
        guides: [
          {
            title: {
          ...
          {
            title: {
              fr: 'Prix peinture Montréal — estimation commerces et bureaux',
              en: 'Painting prices Montreal — estimate for businesses and offices',
            },
            href: '/blog/prix-peinture-montreal',
          },
          {
        ...
        projectsTitle: {
          ...
          en: 'Projects completed in Montreal businesses and offices',
        },
        projects: {
          fr: [
            {
        ...
        aboutTitle: {
          ...
          en: 'An experienced commercial team',
        },
        aboutDescription: {
          fr: "Nos peintres sont formés pour intervenir dans les environnements professionnels, avec : respect des zones sensibles, planification flexible, gestion des risques, protection complète de l'équipement.",
          en: 'Our painters are trained to work in professional environments, with: respect for sensitive areas, flexible planning, risk management, complete protection of equipment.',
        },
        ctaTitle: {
          fr: 'Obtenez votre soumission pour un projet commercial à Montréal',
          en: 'Get your quote for a commercial project in Montreal',
        },
        ctaDescription: {
          fr: 'Nous offrons un service adapté à la réalité des entreprises montréalaises.',
        ...
        images: [
          { src: img5969, alt: 'Peinture commerciale Montréal' },
          { src: img5970, alt: 'Peinture commerciale Montréal' },
          { src: img5971, alt: 'Peinture commerciale Montréal' },
          { src: img5972, alt: 'Peinture commerciale Montréal' },
          { src: img5973, alt: 'Peinture commerciale Montréal' },
          { src: img5974, alt: 'Peinture commerciale Montréal' },
        ],
        subServices: {
          interior: {
            title: {
          ...
          exterior: {
            ...
            link: '/services/peinture-commerciale/exterieure/montreal',
            linkText: {
              fr: 'Page dédiée',
              en: 'Dedicated page',
            },
