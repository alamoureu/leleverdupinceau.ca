    ...
    cities: {
      brossard: {
        ...
        whyUsTitle: {
          ...
          en: 'A durable finish for modern properties in Brossard',
        },
        whyUsContent: {
          fr: [
        ...
        whyUsOutro: {
          ...
          en: 'We work on: modern claddings (wood, vinyl, aluminum), soffits, facades, terraces, fences, garages, exterior stairs, balconies.',
        },
        subServicesTitle: {
        ...
        ctaTitle: {
          ...
          en: 'Get your quote for an exterior project in Brossard',
        },
        ctaDescription: {
      ...
      laval: {
        ...
        whyUsTitle: {
          ...
          en: 'A durable finish adapted to Laval climate',
        },
        whyUsContent: {
          fr: [
        ...
        whyUsOutro: {
          ...
          en: 'We work on: wood, brick, stucco, aluminum, vinyl claddings, soffits, galleries, stairs, fences, garages and exterior structures.',
        },
        subServicesTitle: {
        ...
        guidesTitle: {
          ...
          en: 'Prepare your exterior painting in Laval well',
        },
        guides: [
          {
            title: {
        ...
        ctaTitle: {
          ...
          en: 'Get your quote for an exterior project in Laval',
        },
        ctaDescription: {
      ...
      longueuil: {
        ...
        whyUsTitle: {
          ...
          en: 'A durable protection adapted to South Shore conditions',
        },
        whyUsContent: {
          fr: [
            'Préparation complète des surfaces (nettoyage, décapage, brossage)',
            'Réparations mineures avant peinture',
            'Application uniforme avec produits haute durabilité',
            'Finitions adaptées aux matériaux courants : bois, aluminium, vinyle, crépi, brique, métal',
            'Protection des surfaces adjacentes (fenêtres, portes, végétation)',
            'Travail en hauteur sécuritaire et conforme aux normes',
          ],
          en: [
            'Complete surface preparation (cleaning, stripping, brushing)',
            'Minor repairs before painting',
            'Uniform application with high durability products',
            'Finishes adapted to common materials: wood, aluminum, vinyl, stucco, brick, metal',
            'Protection of adjacent surfaces (windows, doors, vegetation)',
            'Safe work at height and compliant with standards',
          ],
        },
        whyUsIntro: {
        ...
        whyUsOutro: {
          fr: 'Nous travaillons sur : revêtements extérieurs, soffites, boiseries, façades, balcons, escaliers, clôtures, garages et structures secondaires.',
          en: 'We work on: exterior claddings, soffits, woodwork, facades, balconies, stairs, fences, garages and secondary structures.',
        },
        subServicesTitle: {
        ...
        aboutTitle: {
          ...
          en: 'A team specialized in exterior painting in Longueuil',
        },
        aboutDescription: {
          fr: 'Nos peintres : maîtrisent les exigences du climat de la Rive-Sud, connaissent les matériaux typiques de Longueuil, travaillent proprement, rapidement et sécuritairement.',
          en: 'Our painters: master the requirements of the South Shore climate, know the typical materials of Longueuil, work cleanly, quickly and safely.',
        },
        ctaTitle: {
          fr: 'Obtenez votre soumission pour un projet extérieur à Longueuil',
          en: 'Get your quote for an exterior project in Longueuil',
        },
        ctaDescription: {
      ...
      montreal: {
        ...
        whyUsTitle: {
          ...
          en: 'A durable protection adapted to Montreal climate',
        },
        whyUsContent: {
          fr: [
        ...
        whyUsOutro: {
          ...
          en: 'We work on: house and plex facades, claddings, soffits, exterior woodwork, balconies, stairs, fences, garages, small exterior structures.',
        },
        subServicesTitle: {
        ...
        guides: [
          ...
          {
            title: {
              fr: 'Prix peinture Montréal – intérieur et extérieur',
              en: 'Painting prices Montreal – interior and exterior',
            },
            href: '/blog/prix-peinture-montreal',
          },
        ],
        ...
        ctaTitle: {
          ...
          en: 'Get your quote for an exterior project in Montreal',
        },
        ctaDescription: {
          fr: 'Nous intervenons rapidement dans les quartiers résidentiels et mixtes de Montréal.',
